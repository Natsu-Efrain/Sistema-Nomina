         ...
         <div class="contenedor">
            <section class="contenido-header">
                <section class="textos-header">
                    <h1>Nóminas</h1>
                    <p>Consulta y visualización de las nóminas cuando sea necesario, además de poder descargarlas de forma segura.</p>
                    <a href="#" data-toggle="modal" data-target="#exampleModal2">Leer más</a>
                </section>
        ...
        <div class="contenedor">
            <section class="contenido-header">
                ...
                <section class="textos-questions">
                    ...
                    <p>Consulta de reportes y nómianas anteriores.</p>
                    <a href="reportesEmpleado.html">Leer más</a>
                </section>
            </section>
        </div>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 mb-5 mb-lg-0">
          ...
          <p class="lead mb-0">Av. Té 950, Col. Granjas México, 08400 México, DIF</p>
        </div>
        ...
        <div class="col-lg-4">
          <h4 class="text-uppercase mb-4">Acerca de</h4>
            <p class="lead mb-0">Sistema de Nomina desarrollado por el equipo # para la materia Ingenieria de Software.</p>
        </div>
