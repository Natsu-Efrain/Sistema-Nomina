               ...
               <div class="contenedor">
                <section class="contenido-header-generic">
                    <section class="textos-header">
                        <h1>Datos personales <br> Recursos Humanos</h1>
                    </section>
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                      <input type="number" class="form-control" id="idEmpleado" disabled value="${IdEmpleado}"> 
                  </div>
                  ...
                  <div class="col-sm-8">
                      <input type="number" class="form-control" id="numTelefono" disabled value="${numTelefono}">
                  </div>
              </div>
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                      <input type="text" class="form-control" id="numeroExterior" disabled value="${numeroExterior}">
                  </div>
                  
                  <label for="colonia" class="col-sm-4 col-form-label">Colonia</label>
                  <div class="col-sm-8">
                      <input type="text" class="form-control" id="colonia" disabled maxlength="100" value="${colonia}" >
                  </div>
        ...
        <div class="card h-100">
          ...
          <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-8">
                      <input type="text" class="form-control" id="fechaIngreso" disabled value="${fechaIngreso}">
                  </div>
