	...
	<body class="is-preload">
		...
		<!-- Signup Form -->
			<form method="get" action="/Sistema-Nomina/Login">
				...
				<p>¿Olvidaste tu contraseña? <a href="recuperarPassword.jsp">Haz clic aquí</a></p> 

		<!-- Scripts -->
			<script src="js/main.js"></script>
        
        <div id="bg"><div class="visible top" style="background-image: url(&quot;img/portfolio/imagen/bg01.jpg&quot;); background-position: center center;"></div><div class="" style="background-image: url(&quot;img/portfolio/imagen/bg02.jpg&quot;); background-position: center center;"></div><div class="" style="background-image: url(&quot;img/portfolio/imagen/bg03.jpg&quot;); background-position: center center;"></div></div>
