...
<div class="row">
  <div class="col-3">
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
      <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#v-pills-home" role="tab" aria-controls="v-pills-home" aria-selected="true">Agregar Empleado</a>
      <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#v-pills-profile" role="tab" aria-controls="v-pills-profile" aria-selected="false">Agregar Puesto</a>
      <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#v-pills-messages" role="tab" aria-controls="v-pills-messages" aria-selected="false">Crear Area</a>
      <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="#editarUsuario" role="tab" aria-controls="editarUsuario" aria-selected="false">Editar Usuario</a>
    </div>
  </div>
  ...
  <div class="form-row">
    ...
    <div class="col-md-2 mb-3">
      ...
      <input type="text" class="form-control" id="ApellidoP"  value="" required>
    </div>
       <div class="col-md-2 mb-3">
      <label for="ApellidoM">Apellido Materno</label>
      <input type="text" class="form-control" id="ApellidoM" value="" required>
    </div>
      <div class="col-md-2 mb-3">
      <label for="ApellidoM">Numero Telefono</label>
      <input type="number" class="form-control" id="ApellidoM" value="" required>
    </div>
  </div>
  ...
  <div class="form-row">
    <div class="col-md-5 mb-3">
      ...
      <input type="text" class="form-control" id="calle"  value="" required>
    </div>
    <div class="col-md-2 mb-3">
      <label for="numExt">Numero Exterior</label>
      <input type="text" class="form-control" id="numExt"  value="" required>
    </div>
      <div class="col-md-2 mb-3">
      <label for="colonia">Colonia</label>
      <input type="text" class="form-control" id="colonia" value="" required>
    </div>
  </div>
            
 <div class="form-row">
    <div class="col-md-2 mb-3">
      <label for="calle">Delegacion</label>
      <input type="text" class="form-control" id="calle"  value="" required>
    </div>
    <div class="col-md-2 mb-3">
      <label for="numExt">Estado</label>
      <input type="text" class="form-control" id="numExt"  value="" required>
    </div>
      <div class="col-md-1 mb-3">
      <label for="colonia">C.P.</label>
      <input type="number" class="form-control" id="colonia" value="" required>
    </div>
  </div>
...
<form>
  <select class="custom-select my-1 mr-sm-2 col-2 mb-3" id="claseEmpleado">
    <option selected disabled>Clase Empleado</option>
    <option value="1">Confianza</option>
    <option value="2">Base</option>
  </select>
        
        <select class="custom-select my-1 mr-sm-2 col-2 mb-3" id="tipoPago">
    ...
    <div class="col-md-2 mb-3">
      ...
      <input type="text" class="form-control" id="fechaIngreso"  value="sysdate" required disabled>
    </div>
 ...
 <select class="custom-select my-1 mr-sm-2 col-2 mb-3" id="puesto">
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="nombrePuesto"  value="" required>
    </div>
    <div class="col-md-2 mb-3">
      <label for="salarioPuesto">Salario del Puesto</label>
      <input type="number" class="form-control" id="salarioPuesto"  value="" required>
    </div>
       <div class="col-md-2 mb-3">
      <label for="horas">Horas de Jornada</label>
      <input type="text" class="form-control" id="horas" value="" required>
    </div>
  </div>
          
        </form>
          
          <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#creacionPuesto">Agregar nuevo puesto</button> 
    ...
    <option value="4" disabled>Comercial</option>
          ...
          <div class="form-group">
            ...
            <div class="col-md-3 mb-3">
            <label for="nuevaArea" class="col-form-label">Nombre de nueva Area:</label>
        ...
        <div class="form-group">
            ...
            <label for="valesDespensa" class="col-form-label">Vales de despensa correspondiente ($):</label>
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#creacionArea">Crear</button>
      ...
      <div class="tab-pane fade" id="editarUsuario" role="tabpanel" aria-labelledby="editarUsuario">
          ...
          <div class="form-group row">
              ...
              <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#staticBackdrop">Buscar</button>
          </div>
...
<div class="form-row">          
 <select class="custom-select my-1 mr-sm-2 col-5 mb-5" id="claseEmpleado">
    <option selected disabled>Clase Empleado</option>
    <option value="1">Confianza</option>
    <option value="2">Base</option>
  </select>
  ...
  <select class="custom-select my-1 mr-sm-2 col-5 mb-5" id="tipoPago">
    <option selected disabled>Tipo Pago</option>
    <option value="1">Semanal</option>
    <option value="2">Quincenal</option>
  </select>
  ...
  <!--  Aqui se deberan cargar las areas existentes-->
    ...
    <select class="custom-select my-1 mr-sm-2 col-5 mb-5" id="area">
    <option selected disabled>Seleccione Area</option>
    <option value="1">Recursos Humanos</option>
    <option value="2">Tecnologia</option>
    <option value="3">Finanzas</option>
 ...
 <select class="custom-select my-1 mr-sm-2 col-5 mb-5" id="puesto">
    ...
    <option value="2">...</option>
        ...
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#edicionDatos">Confirmar Edición</button> <br><br>
...
<div class="modal fade" id="creacionPuesto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Confirmacion Puesto</h5>
          <hr>
    ...
    <div class="portfolio-modal modal fade" id="creacionArea" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="portfolioModal1Label" aria-hidden="true">
    
         <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Confirmacion Area</h5>
          <hr>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
    ...
    <div class="portfolio-modal modal fade" id="edicionDatos" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="edicionDatos" aria-hidden="true">
