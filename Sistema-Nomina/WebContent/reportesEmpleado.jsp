   ...
   <header>
            ...
            <section class="contenido-header">
                <section class="textos-header">
                    <h1 class="h1T">Reportes de Empleado</h1>

   <div class="form-group row">
       
    <div class="col-auto my-1">
      <label class="mr-sm-3 sr-only" for="inlineFormCustomSelect">Preference</label>
      <select class="custom-select mr-sm-3" id="periodo">
    ...
    <div class="col-sm-6">
            ...
            <button type="button" class="btn btn-secondary" data-toggle="modal" data-target="#portfolioModal1">Buscar</button>
          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                ...
                <h2 class="portfolio-modal-title text-secondary text-uppercase mb-0">Reporte de Nomina</h2>
                  <hr>
